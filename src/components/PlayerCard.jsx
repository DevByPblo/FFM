...
const PlayerCard = ({ player }) => {
  ...
  return (
    <div className="relative w-80 h-[480px] bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 rounded-2xl shadow-2xl overflow-hidden transform hover:scale-75 transition-all duration-300 scale-60">
      {/* Background Pattern */}
      ...
      <div className="relative p-4 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <img src={player.Flag} alt={player.Nationality} className="w-8 h-6 rounded shadow-lg" />
          <img src={player.Club_Logo} alt={player.Club} className="w-8 h-8 rounded shadow-lg" />
        </div>
      ...
      <div className="px-4 mt-4 grid grid-cols-2 gap-4 text-white">
        <div className="bg-black/20 rounded-lg p-3 backdrop-blur-sm">
          <h3 className="text-xs font-bold text-center mb-2 text-gray-300 uppercase tracking-wider">Attack</h3>
        ...
        <div className="bg-black/20 rounded-lg p-3 backdrop-blur-sm">
          <h3 className="text-xs font-bold text-center mb-2 text-gray-300 uppercase tracking-wider">Skill</h3>
        ...
        <div className="bg-black/20 rounded-lg p-3 backdrop-blur-sm">
          <h3 className="text-xs font-bold text-center mb-2 text-gray-300 uppercase tracking-wider">Movement</h3>
        ...
        <div className="bg-black/20 rounded-lg p-3 backdrop-blur-sm ">
          <h3 className="text-xs font-bold text-center mb-2 text-gray-300 uppercase tracking-wider">Defense</h3>
